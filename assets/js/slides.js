...
/*
      if($(panel).hasClass("top")){console.log($(this).children(), $(this).children().outerWidth());}
...
*/
          ...
          if ((totalWidth > documentWidth - Math.round(panelsPadding) ) || ((window.isMobile || documentWidth < 767) && forceMobileView)) {
            $(desktop).addClass('hidden');
            $(compact).removeClass('hidden');
          } else {
            $(desktop).removeClass('hidden');
